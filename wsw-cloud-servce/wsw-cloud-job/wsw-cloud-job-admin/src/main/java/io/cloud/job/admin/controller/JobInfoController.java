package io.cloud.job.admin.controller;

import io.cloud.job.admin.core.cron.CronExpression;
import io.cloud.job.admin.core.exception.XxlJobException;
import io.cloud.job.admin.core.model.XxlJobGroup;
import io.cloud.job.admin.core.model.XxlJobInfo;
import io.cloud.job.admin.core.model.XxlJobUser;
import io.cloud.job.admin.core.route.ExecutorRouteStrategyEnum;
...
public class JobInfoController {
    ...
    @ResponseBody
    public ReturnT<String> addApi(@RequestBody XxlJobInfo jobInfo) {
        return xxlJobService.addApi(jobInfo);
    }
