package io.cloud.job.admin.service.impl;
...
import io.cloud.job.admin.core.model.XxlJobLogReport;
import io.cloud.job.admin.core.route.ExecutorRouteStrategyEnum;
import io.cloud.job.admin.core.thread.JobScheduleHelper;
import io.cloud.job.admin.core.util.I18nUtil;
import io.cloud.job.admin.dao.*;
...
public class XxlJobServiceImpl implements XxlJobService {
    ...
    public ReturnT<String> addApi(XxlJobInfo jobInfo) {
        ...
        this.start(Integer.parseInt(add.getContent()));
        return add;
    }
