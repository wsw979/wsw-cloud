package io.cloud.datasource.util;
...
public class SnowIdUtils {
    ...
    private static class SnowFlake {
         ...
         * 内部类对象
         */
        private static final io.cloud.datasource.util.SnowIdUtils.SnowFlake SNOW_FLAKE = new io.cloud.datasource.util.SnowIdUtils.SnowFlake();
    ...
    public static long uniqueLong() {
        return io.cloud.datasource.util.SnowIdUtils.SnowFlake.SNOW_FLAKE.nextId();
    }
